...
#### Data of the subjects involved in the training set
...
#### Data of the subjects involved in the testing set
...
. Names with repeated "BodyBody" were replace with "Body"
...
A merged data set is created by 
